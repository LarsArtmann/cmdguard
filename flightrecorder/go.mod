module github.com/larsartmann/cmdguard/flightrecorder

go 1.26.5

require github.com/larsartmann/cmdguard/v4 v4.0.0
...
require (
	...
	github.com/charmbracelet/ultraviolet v0.0.0-20260729212402-27c57c10ce6f // indirect
