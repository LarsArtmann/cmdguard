...
func TestFilePath(t *testing.T) {
	...
	t.Run("ParseFilePath relative", func(t *testing.T) {
		...
		fp, err := v4.ParseFilePath("./test.txt", false)
		if err != nil {
	...
	t.Run("FilePath Absolute not empty", func(t *testing.T) {
		...
		fp, _ := v4.ParseFilePath("test.txt", false)
		if fp.Absolute() == "" {
	...
	t.Run("FilePath Dir", func(t *testing.T) {
		...
		fp, _ := v4.ParseFilePath("/home/user/file.txt", false)
		if fp.Dir() == "" {
	...
	t.Run("ParseFilePath valid", func(t *testing.T) {
		...
		fp, err := v4.ParseFilePath("/tmp/test.txt", false)
		if err != nil {
			t.Fatal(err)
		}
		if fp.String() == "" {
	...
	t.Run("FilePath MarshalText", func(t *testing.T) {
		...
		fp, _ := v4.ParseFilePath("/tmp/test.txt", false)
	...
	t.Run("FilePath Join", func(t *testing.T) {
		...
		fp, _ := v4.ParseFilePath("/tmp", false)
