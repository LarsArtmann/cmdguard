...
//	    v4.WithCLIVersion[Config]("1.0.0"),
//	)
//	docCmd, err := v4.DoctorCommand[Config](cli)
//	if err != nil {
//	    log.Fatal(err)
//	}
//	v4.AddCommand(cli, docCmd)
//
// With custom checks:
//
//	docCmd, err := v4.DoctorCommand[Config](cli,
//	    v4.WithDoctorCheck[Config]("database", func(ctx context.Context) error {
//	        return db.Ping(ctx)
//	    }),
//	)
