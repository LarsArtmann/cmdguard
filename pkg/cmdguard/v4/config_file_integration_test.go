...
func TestConfigFileNestedStructs(t *testing.T) {
	...
	cmd, err := v4.NewCommand(
		"test",
		v4.NoFlags{},
		func(_ context.Context, cfg *nestedConfigRoot, _ v4.NoFlags) error {
...
func runPrecedenceTest(t *testing.T, configPath, envValue string, args []string, wantName string) {
	...
	cmd, err := v4.NewCommand(
		"test",
		v4.NoFlags{},
		func(_ context.Context, cfg *precedenceConfig, _ v4.NoFlags) error {
