...
func TestPort(t *testing.T) {
	...
	t.Run("ParsePort error cases", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				t.Parallel()
				testParseError(t, func() (v4.Port, error) { return v4.ParsePort(tt.input) }, "port")
			})
		}
	})
	...
	t.Run("PortFromInt invalid", func(t *testing.T) {
		t.Parallel()
		testParseError(t, func() (v4.Port, error) { return v4.PortFromInt(70000) }, "port")
	})

	t.Run("Port IsEmpty", func(t *testing.T) {
		t.Parallel()

		p, _ := v4.ParsePort("8080")
		if p.IsEmpty() {
