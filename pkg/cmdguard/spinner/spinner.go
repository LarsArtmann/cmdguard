...
//	    v2.WithMiddleware(spinner.Middleware[Config]("Loading...")),
//	)
package spinner
...
func Middleware[T any](title string) v2.Middleware[T] {
...
func MiddlewareWithConfig[T any](cfg Config) v2.Middleware[T] {
	return func(_ context.Context, _ *T, _ v2.CommandInfo, next func() error) error {
