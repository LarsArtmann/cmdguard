...
func TestHostPort(t *testing.T) {
	...
	t.Run("ParseHostPort error cases", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				...
				testParseError(
					t,
					func() (v3.HostPort, error) { return v3.ParseHostPort(tt.input) },
					"host:port",
				)
			})
		}
	...
	t.Run("NewHostPort valid", func(t *testing.T) {
		...
		hp, err := v3.NewHostPort("example.com", "443")
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("ParseHostPort valid", func(t *testing.T) {
		...
		hp, err := v3.ParseHostPort("127.0.0.1:3000")
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("HostPort IsEmpty", func(t *testing.T) {
		...
		hp, _ := v3.ParseHostPort("localhost:8080")
		if hp.IsEmpty() {
	...
	t.Run("HostPort MarshalText", func(t *testing.T) {
		...
		hp, _ := v3.ParseHostPort("example.com:443")
