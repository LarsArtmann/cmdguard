...
| File → depends on | errors | config | config_parse | config_set | flags | flags_parse | flags_validate | flags_suggest | flag_helpers | type_handler | type_helpers | types_* | scope | flow_ctx | middleware | cli | cli_options | cli_accessors | cli_command | cli_output | output | command | completion | editor | manpage | suggest |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| cli.go | ● | | | | ● | | | | | | | | ● | ● | ● | | ● | | ● | ● | ● | ● | | | | | |
| cli_command.go | ● | | | | ● | | | | ● | ● | | | | | ● | ● | | | | | | ● | ● | | | |
| cli_options.go | | | | | | | | | | | | | ● | | ● | ● | | | | | | | | | | |
