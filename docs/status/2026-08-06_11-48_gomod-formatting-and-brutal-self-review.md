...
| 10 | **The "accepted clone groups" comment in AGENTS.md** is now stale relative to the post-`tidy` go.mod (no clone data changed, but the *go.mod* itself changed). | Low risk. |
