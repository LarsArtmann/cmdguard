...
| M13 | **Website build verification** — `npm run build` in `website/`, check for stale references                                                                                                                                                 | 20%→80%   | Medium   | 30min  | —    | Website doesn't have broken builds or stale content           |
...
| Sub# | Sub-task                                                | Time  |
| ---- | ------------------------------------------------------- | ----- |
| 13.1 | `cd website && npm run build`                           | 10min |
