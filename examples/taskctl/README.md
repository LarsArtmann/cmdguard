...
| Feature                      | Where               | How                                                                                                                       |
| ---------------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| **CLI Construction**         | main.go             | `NewCLI` with version, env prefix, config file, signal handling, strict validation, config validation, middleware, groups |
...
| `WithSignalHandling`         | main.go             | Graceful SIGINT/SIGTERM                                                                                                   |
...
| `ParseOutputFormat`          | commands.go         | list --format json/csv/yaml                                                                                               |
...
| `MustVersionCommand`         | commands.go         | Auto version subcommand                                                                                                   |
