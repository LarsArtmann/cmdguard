...
func newTestCLI(t *testing.T) *v4.CLI[AppConfig] {
	t.Helper()
...
func mustExecOnCLI(t *testing.T, cli *v4.CLI[AppConfig], args ...string) {
	t.Helper()
...
func runAndFailOnError(t *testing.T, cli *v4.CLI[AppConfig], args ...string) {
	t.Helper()
...
func newEmptyTestCLI(t *testing.T) *v4.CLI[AppConfig] {
	t.Helper()
...
func TestErrorHandling_FlagError(t *testing.T) {
	...
	if flagErr, ok := errors.AsType[*v4.FlagError](err); ok {
...
func TestErrorHandling_ExitCode(t *testing.T) {
	...
	if exitCoder, ok := errors.AsType[*v4.ExitError](err); ok {
		if exitCoder.Code != 2 {
...
func TestParsePriority(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			...
			got, err := v4.ParseEnum(tt.input, strings.Split(allowedPriorities, ","))
			if tt.err {
				if err == nil {
...
func TestValueOrDefault(t *testing.T) {
	...
	s := "hello"
	if got := v4.ValueOrDefault(&s, "default"); got != "hello" {
		t.Errorf("ValueOrDefault = %q, want %q", got, "hello")
	}
	if got := v4.ValueOrDefault[string](nil, "default"); got != "default" {
...
func TestEnsureValid(t *testing.T) {
	...
	s := "value"
	if err := v4.EnsureValid(&s, "test"); err != nil {
		t.Errorf("EnsureValid with non-nil: %v", err)
	}
	if err := v4.EnsureValid[string](nil, "test"); err == nil {
...
func TestEnumType(t *testing.T) {
	...
	e, err := v4.ParseEnum("high", []string{"low", "medium", "high"})
	if err != nil {
...
func TestEnumType_Invalid(t *testing.T) {
	...
	_, err := v4.ParseEnum("urgent", []string{"low", "medium", "high"})
	if err == nil {
...
func TestCommandError(t *testing.T) {
	...
	cmdErr := v4.NewCommandError("test", inner)
...
func TestServiceError(t *testing.T) {
	...
	inner := fmt.Errorf("inner error")
	svcErr := v4.NewServiceError("*TaskStore", inner)
...
func TestNewExitError(t *testing.T) {
	...
	exitErr, err := v4.NewExitError(42, fmt.Errorf("test"))
	if err != nil {
...
func TestNewExitError_InvalidCode(t *testing.T) {
	...
	_, err := v4.NewExitError(300, fmt.Errorf("test"))
	if err == nil {
...
func TestFlagError(t *testing.T) {
	...
	flagErr := v4.NewFlagError("port", fmt.Errorf("out of range"))
...
func TestFlagError_WithSuggestion(t *testing.T) {
	...
	flagErr := v4.NewFlagErrorWithSuggestion("prot", fmt.Errorf("unknown flag"), "port")
